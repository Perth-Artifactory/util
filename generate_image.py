...
boarder = 20
bar_width = 10
draw.rounded_rectangle((boarder, boarder, boarder+bar_width, height-boarder), fill=(255, 0, 0), outline=(255, 0, 0), radius=10)

time_str_left, _, _, _ = draw.textbbox((width-boarder, height/2), time_string, font_size=140, anchor='rm')
